export class donutMultiplierClass {
  ...
  enableMultiplierUse() {
    if (this.amount > 0) {
      document
        .getElementById("multiplierUseButton")
  ...
  useMultiplier() {
    ...
    this.amount--;
    document.querySelector("#multiplierDisplay").innerHTML =
      "x" + this.multiplier;
    totalMultipliersUsed.innerHTML =
      "Total Multipliers used: " + this.numberOfMultipliersUsed;
